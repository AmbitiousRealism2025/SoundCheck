      ...
      <DialogContent className="max-w-sm p-8" data-testid="onboarding-modal">
        ...
        <div className="space-y-4 mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium" data-testid="text-rehearsals-feature">Rehearsals Tab</p>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium" data-testid="text-gigs-feature">Gigs Tab</p>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium" data-testid="text-quick-add-feature">Quick Add</p>
